...
def test_add_service_commitment_non_existing_shift(mock_repos):
    ...
    commitment.to_dict.return_value = {"_id": "None"}  # Function returns "None" as string
...
def test_add_multiple_service_commitments_mixed(mock_repos):
    ...
    commitment_2.to_dict.return_value = {"_id": "None"}  # Function returns "None" as string
    ...
    # Call function
    result = add_service_commitments(commitments_repo, shifts_repo, [commitment_1, commitment_2, commitment_3])

    # Expected result
    assert result == [
        {"service_commitment_id": "commitment_1", "success": True},
        {"service_commitment_id": "None", "success": True},  # Matches current behavior
