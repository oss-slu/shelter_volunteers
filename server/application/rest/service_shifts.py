...
def service_shift():
    ...
    if request.method == "GET":
        ...
        if shelter_id:
            shifts = shift_add_use_case(repo, new_shift=None, existing_shifts=None, shelter_id=shelter_id)
            return Response(
        ...
        result = shift_add_use_case(repo, new_shift, existing_shifts=[], shelter_id=None)
